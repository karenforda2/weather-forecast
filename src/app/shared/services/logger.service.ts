...
export enum Level { off = 0, error = 1, warn = 2, info = 3, log = 4 }
...
export class Logger {
	...
	public error(...messages: any[]) { this.logToConsole(Level.error, messages); }
	public warn(...messages: any[]) { this.logToConsole(Level.warn, messages); }
	public info(...messages: any[]) { this.logToConsole(Level.info, messages); }
	public log(...messages: any[]) { this.logToConsole(Level.log, messages); }
